...
const Comments = (props) => {
  ...
  const commentElement = (comment) => (
    <Comment key={comment.comment_id} id={comment.comment_id}>
      ...
      />
      <Comment.Content>
        {/* CUSTOMIZATION: as="span" for a11y */}
        <Comment.Author as="span">{comment.author_name}</Comment.Author>
        <Comment.Metadata>
          <span>
            {' '}
            {/* CUSTOMIZATION: use formatRelativeDate instead of moment */}
        ...
        <Comment.Actions>
          {/* CUSTOMIZATION: as="button" type="button" for a11y */}
          {comment.can_reply && (
            <Comment.Action
              as="button"
              type="button"
  ...
  return (
    <Container className="comments">
      ...
      {/* CUSTOMIZATION: threaded={false} */}
      <Comment.Group threaded={false} id={'discussion'}>
