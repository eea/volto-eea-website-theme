...
import NewBlockAddButton from '@plone/volto/components/manage/Blocks/Container/NewBlockAddButton';
  ...
  return (
    ...
    >
      <div
        ...
        onClick={(e) => {
          e.block = block;
          // Block/Edit already handles clicks on the card itself. Only handle
          // the surrounding cell here, preserving modifier keys without toggling twice.
          const childBlock = e.target.closest('.block:not(.inner)');
          if (
            !e.containerSelectionHandled &&
            !e.currentTarget.contains(childBlock)
          ) {
            onSelectBlock(block, e.shiftKey || e.ctrlKey || e.metaKey, e);
          }
        }}
      >
        {type !== 'empty' ? (
        ...
        {type && type !== 'empty' ? (
          ...
          <div
            ...
            onClick={(e) => {
              onSelectBlock(block, e.shiftKey || e.ctrlKey || e.metaKey, e);
              e.containerSelectionHandled = true;
